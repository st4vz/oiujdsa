...
# ─── T2I ───────────────────────────────────────────────────────────────────
_add "$MODELS/clip"         "qwen_3_4b.safetensors" \
...
_add "$MODELS/ckpt"         "detect.safetensors" \
    "https://huggingface.co/gazsuv/sudoku/resolve/main/detect.safetensors"
_add "$MODELS/model_patches" "Z-Image-Turbo-Fun-Controlnet-Union.safetensors" \
...
_add "$MODELS/ultralytics/bbox" "face_yolov8s.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/face_yolov8s.pt"
_add "$MODELS/ultralytics/bbox" "femaleBodyDetection_yolo26.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/femaleBodyDetection_yolo26.pt"
_add "$MODELS/ultralytics/bbox" "female_breast-v4.2.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/female_breast-v4.2.pt "
_add "$MODELS/ultralytics/bbox" "nipples_yolov8s.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/nipples_yolov8s.pt"
_add "$MODELS/ultralytics/bbox" "vagina-v4.2.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/vagina-v4.2.pt"
_add "$MODELS/ultralytics/bbox" "assdetailer.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/assdetailer.pt"
_add "$MODELS/ultralytics/bbox" "Eyeful_v2-Paired.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/Eyeful_v2-Paired.pt"
_add "$MODELS/ultralytics/bbox" "Eyes.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/Eyes.pt"
_add "$MODELS/ultralytics/bbox" "FacesV1.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/FacesV1.pt"
_add "$MODELS/ultralytics/bbox" "hand_yolov8s.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/hand_yolov8s.pt"
_add "$MODELS/ultralytics/bbox" "foot-yolov8l.pt" \
    "https://huggingface.co/st4vz/process_checkpoint/resolve/main/foot-yolov8l.pt"
...
# T2I: Qwen3 VL config files (tiny, batch them all)
_QWEN_DIR="$MODELS/prompt_generator/Qwen3-VL-4B-Instruct-heretic-7refusal"
_QWEN_BASE="https://huggingface.co/svjack/Qwen3-VL-4B-Instruct-heretic-7refusal/resolve/main"
for _f in added_tokens.json chat_template.jinja config.json generation_config.json \
    ...
    _add "$_QWEN_DIR" "$_f" "$_QWEN_BASE/$_f"
done
...
# ANIMATOR: detection (mirrored to st4vz — plain HF storage, aria2c safe)
