...
<body>
    ...
    <div class="container" id="main">
        ...
        <div style="margin-bottom: 16px; border-radius: 12px; overflow: hidden; background: rgba(0,0,0,0.03); border: 1px solid rgba(255,107,132,0.15); padding: 12px; text-align: center;">
            <canvas id="snakeGame" width="480" height="200" style="background: rgba(74,46,55,0.06); border-radius: 8px; border: 1px solid rgba(255,107,132,0.15); display: block; margin: 0 auto;"></canvas>
